"""Переводим нашу структуру в последовательность битов"""
...
class ToySerializer(serializers.Serializer):
    """Declares the attributes that represent   the field from ToyModel that we want to be serialized. Exclude 'created' field."""
